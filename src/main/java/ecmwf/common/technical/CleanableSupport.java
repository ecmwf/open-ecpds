...
/**
 * A helper class that encapsulates Java's Cleaner mechanism to provide safe and
 * automatic cleanup of resources.
 *
 * This class is useful when you want finalization-like behavior without using
 * deprecated `finalize()`.
 */
public class CleanableSupport {
	 ...
	 *
	 * @param owner   the object being cleaned (typically 'this'); used as a
	 *                reference by the Cleaner
	 * @param cleanup the cleanup logic to execute (e.g. closing streams or
	 *                releasing resources)
	 */
	...
	/**
	 * Returns true if this is the first call to clean the resource. Intended for
	 * manual cleanup with potential exception handling.
	 */
	...
	/**
	 * Triggers cleanup manually. Safe to call multiple times; cleanup logic will
	 ...
	 * @param gcTriggered true if triggered by GC, false if manual close()
	 */
