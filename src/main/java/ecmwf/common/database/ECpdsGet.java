...
final class ECpdsGet {
    ...
    DBResultSet getSortedBadDataTransfers(final String paramSort, final String paramOrder, final int paramStart,
            final int paramLength, final String paramSearch) throws SQLException, IOException {
        return _database.executeSelect("ECpdsBase", "getSortedBadDataTransfers", new String[] { "sort=" + paramSort,
                "order=" + paramOrder, "start=" + paramStart, "length=" + paramLength, "search=" + paramSearch });
    }
    ...
    void upsertPortalBytesSnapshot(final java.sql.Timestamp minute, final String user, final long uploadBytes,
            final long downloadBytes) throws SQLException, IOException {
        _database.executeUpdate("ECpdsBase", "upsertPortalBytesSnapshot", new String[] { "user=" + user,
                "minute=" + minute, "uploadBytes=" + uploadBytes, "downloadBytes=" + downloadBytes });
    }

    DBResultSet getRecentPortalBytesSnapshots(final int retentionHours) throws SQLException, IOException {
        return _database.executeSelect("ECpdsBase", "getRecentPortalBytesSnapshots",
                new String[] { "retentionHours=" + retentionHours });
    }

    void deleteOldPortalBytesSnapshots(final int retentionHours) throws SQLException, IOException {
        _database.executeUpdate("ECpdsBase", "deleteOldPortalBytesSnapshots",
                new String[] { "retentionHours=" + retentionHours });
    }
    ...
    DBResultSet getDataTransferCountAndMetaDataByFilter(final String paramDestination, final String paramCountBy,
            ...
            final String paramExpired, final String paramProxy, final String paramMover,
            final java.sql.Timestamp paramFrom, final java.sql.Timestamp paramTo,
            final java.lang.String paramPrivilegedUser, final java.sql.Timestamp paramScheduledBefore,
            final boolean requiresDataFile) throws SQLException, IOException {
    ...
    DBResultSet getDataTransfersByFilter(final String paramDestination, final String paramTarget,
            ...
            final String paramProxy, final String paramMover, final java.sql.Timestamp paramFrom,
        ...
        return _database.executeSelect("ECpdsBase", "getDataTransfersByFilter",
                new String[] { "destination=" + paramDestination, "target=" + paramTarget, "stream=" + paramStream,
                        ...
                        "proxy-=" + paramProxy, "mover-=" + paramMover, "from=" + paramFrom.getTime(),
                        "to=" + paramTo.getTime() });
    }
    ...
    DBResultSet getSortedDataTransfersByFilter(final String paramDestination, final String paramTarget,
            ...
            final String paramAsap, final String paramEvent, final String paramDeleted, final String paramExpired,
            final String paramProxy, final String paramMover, final java.sql.Timestamp paramFrom,
            final java.sql.Timestamp paramTo, final String paramSort, final String paramOrder, final int paramStart,
        ...
        return _database.executeSelect("ECpdsBase", "getSortedDataTransfersByFilter",
                new String[] { "destination=" + paramDestination, "target=" + paramTarget, "stream=" + paramStream,
                        ...
                        "event-=" + paramEvent, "deleted-=" + paramDeleted, "expired-=" + paramExpired,
                        "proxy-=" + paramProxy, "mover-=" + paramMover, "from=" + paramFrom.getTime(),
                        "to=" + paramTo.getTime(), "sort=" + paramSort, "order=" + paramOrder, "start=" + paramStart,
                        "length=" + paramLength });
    }
    ...
    DBResultSet getSortedDataTransfersByStatusOnDate(final String paramStatus, final java.sql.Timestamp paramFromDate,
        ...
        return _database.executeSelect("ECpdsBase", "getSortedDataTransfersByStatusOnDate", new String[] {
                ...
                "fileName-=" + paramFileName, "source-=" + paramSource, "ts-=" + paramTs, "priority-=" + paramPriority,
                "checksum-=" + paramChecksum, "groupby-=" + paramGroupBy, "identity-=" + paramIdentity,
