...
final class ECtransInputStream extends InputStream implements AutoCloseable {
	 ...
	 *
	 * @param host          the host
	 * @param indexFileName the index file name
	 * @return the vector
	...
	/**
	 * The Class SourceInputStream. A class to allow getting the name of the source
	 * file. This interface is implemented by the various input streams.
	 */
	...
	/**
	 * The Class SimpleInputStream. This stream is used when only one file is to be
	 * retrieved (no index).
	 */
	...
	/**
	 * The Class CachedInputStream. This class is used for each new input stream
	 * added to the queue of the multiple input stream class to read data in advance
	 * and populate a cache.
	 */
	...
	/**
	 * The Class MultipleInputStream. This Class is used when the source is an index
	 * file (multiple files will be retrieved).
	 */
	private static final class MultipleInputStream extends SourceInputStream {
		...
		/**
		 * The thread which read from the various input streams and populate the main
		 * input stream.
		 */
		...
		/**
		 * The Class ConnectionsPool. The purpose of this Thread is to populate the
		 * inputs queue with all the input streams required to retrieve the chunks of
		 * the file.
		 */
		...
		/**
		 * The Class TransferManager. The purpose of this Thread is to process all the
		 * input streams created by the connections pool Thread.
		 */
