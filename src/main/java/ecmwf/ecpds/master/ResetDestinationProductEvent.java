...
public final class ResetDestinationProductEvent extends ResetProductEvent {
    ...
    /** The Constant NAME. */
    public static final String NAME = "ResetDestinationProductEvent";
     ...
     *            the meta time
     */
    public ResetDestinationProductEvent(final String destinationName, final String metaStream, final String metaTime) {
        super(NAME, metaStream, metaTime);
