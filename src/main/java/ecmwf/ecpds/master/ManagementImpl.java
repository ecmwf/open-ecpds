...
final class ManagementImpl extends CallBackObject implements ManagementInterface {
	 ...
	 *
	 * Get the destination names which follow the provided rules for the email
	 * addresses in their contacts!
	 */
	@Override
	 ...
	 * Gets the contacts.
	 *
	 * Retrieve the contacts. If reload is true or the cache is expired then get it
	 * from the configuration files. Otherwise the information is read from the
	 * cache!
	 *
	...
	/**
	 * The Class CleanThread. Listing meant to be used in multiple instances in
	 * parallel!
	 */
