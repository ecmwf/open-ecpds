...
public final class AssociationComparator implements Comparator<Association> {
    ...
    public int compare(final Association assoc1, final Association host2) {
        return _compareAssociation(assoc1, host2);
    }

    /**
     * _compare association.
     *
     * @param assoc1
     *            the assoc1
     * @param assoc2
     ...
     * @return the int
     */
    private static int _compareAssociation(final Association assoc1, final Association assoc2) {
        return Integer.compare(assoc1.getPriority(), assoc2.getPriority());
    }
}
