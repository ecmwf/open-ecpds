...
public class InsertFormAction extends PDSAction {
    ...
    public ActionForward safeAuthorizedPerform(final ActionMapping mapping, final ActionForm form,
        ...
        final var tsaf = (TransferServerActionForm) form;
        tsaf.resetFields();
        if (request.getParameter("transferGroupName") != null) {
            tsaf.setTransferGroupName(request.getParameter("transferGroupName"));
        }
