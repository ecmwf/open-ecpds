 ...
 * <p>
 * Supports bidirectional communication between the client and
 * {@link AssistantService}. Each WebSocket maintains a conversation per HTTP
 * session, streams AI-generated tokens in real time, and supports cancellation
 * and heartbeat pings.
 * </p>
 * <p>
 * Features:
...
public class AssistantWebSocket {
	 ...
	 *
	 * @param httpSession the HTTP session for maintaining conversation state
	 */
	 ...
	 * <p>
	 * Schedules periodic token flush and heartbeat ping tasks, and sets idle
	 * timeout.
	 *
	 ...
	 * </pre>
	 *
	 * @param message the raw JSON message from the client
	 */
	@OnWebSocketMessage
	...
	/**
	 * Buffers a token received from the AI model for batched delivery to the
	 * client.
	 * <p>
	 * If the accumulated tokens exceed {@link #TOKEN_BATCH_SIZE}, the buffer is
	 * immediately flushed to the client via {@link #flushTokenBuffer()}.
	 *
	 * @param token the AI-generated token to buffer
	 * 
	 *              Example:
	 * 
	 *              <pre>
	 ...
	 * <p>
	 * Each flush sends a JSON object with type "token" and the accumulated text.
	 ...
	 * </pre>
	 *
	 * If the session is closed or there are no tokens, this method returns
	 * immediately.
	 */
	 ...
	 * <p>
	 * Signals that the AI assistant has completed its response. Frontend can use
	 * this to finalize UI updates, enable input, or show completion indicators.
	 *
	 * Example payload:
	 * 
	 * <pre>
	 ...
	 * <p>
	 * Use this to notify the frontend of issues during processing, e.g., invalid
	 * JSON, AI failure, or unexpected exceptions.
	 *
