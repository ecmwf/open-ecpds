 ...
 */
public class GetTransferMethodAction extends PDSAction {
    ...
    public ActionForward safeAuthorizedPerform(final ActionMapping mapping, final ActionForm form,
        ...
        if ("checkId".equals(request.getParameter("json"))) {
            ...
            if (id != null && !id.isBlank()) {
                try {
                    TransferMethodHome.findByPrimaryKey(id);
                    exists = true;
        ...
        if (parameters.isEmpty()) {
            request.setAttribute("methods", TransferMethodHome.findAll());
            return mapping.findForward("success");
        }
        request.setAttribute("method", TransferMethodHome.findByPrimaryKey(parameters.get(0).toString()));
        return mapping.findForward("success");
    }
}
