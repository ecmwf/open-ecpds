 ...
 *
 * Returns a lightweight JSON array of all transfer IDs currently in the selection basket — used by
 * the All/None/Invert buttons on the basket page to operate across all pages without requiring the
 * DataTable to render them first.
 *
...
/**
 * The Class GetBasketIdListAction.
 */
public class GetBasketIdListAction extends PDSAction {
