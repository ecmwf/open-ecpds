 ...
 */
public class GetTransferGroupAction extends PDSAction {
    ...
    public ActionForward safeAuthorizedPerform(final ActionMapping mapping, final ActionForm form,
        ...
        if ("checkId".equals(request.getParameter("json"))) {
            ...
            if (id != null && !id.isBlank()) {
                try {
                    TransferGroupHome.findByPrimaryKey(id);
                    exists = true;
        ...
        if (parameters.isEmpty()) {
            request.setAttribute("transfergroups", TransferGroupHome.findAll());
            return mapping.findForward("success");
        }
        request.setAttribute("transfergroup", TransferGroupHome.findByPrimaryKey(parameters.get(0).toString()));
        return mapping.findForward("success");
    }
}
