 ...
 */
public class NotDoneTransferCount extends ModelSearchBase {
     ...
     *            the date
     */
    public NotDoneTransferCount(final String dest, final String product, final String time, final Date date) {
