...
<p><%=System.getProperty("monitor.nickName")%> also implement a Data Portal which is accessible via:<li>ftp, sftp, scp, https and Amazon S3.</li></p>
<p>Data User credentials are required to access this service. Key-Based Authentication is allowed with sftp and scp.</p>
<h3>Your Options</h3>
