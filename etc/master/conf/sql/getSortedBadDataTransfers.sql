...
##
#menu "ECpdsBase"
#name "getSortedBadDataTransfers"
#group "select"
...
#if ('$search' != '')
  AND (DES_NAME LIKE '%$search%' OR HOS_NAME LIKE '%$search%' OR DAT_TARGET LIKE '%$search%' OR STA_CODE LIKE '%$search%' OR DAT_COMMENT LIKE '%$search%')
#fi
#if ('$sort' == '0')
ORDER BY (DES_NAME IS NULL), DES_NAME
#fi
#if ('$sort' == '1')
