...
<i class="bi bi-files text-warning flex-shrink-0"></i>
<span>Web Resources represent individual pages and actions within this Monitor interface. They are grouped into Web Categories and used to define fine-grained access control for Web Users.</span>
</div>
...
<div class="card-header d-flex flex-wrap align-items-center gap-2" style="background:var(--bs-secondary-bg)">
    ...
    <div class="ms-auto d-flex flex-wrap align-items-center gap-2">
        <div class="input-group input-group-sm" style="width:auto">
            ...
            <input type="text" id="resourcesSearch" class="form-control" placeholder="Search fields..." style="min-width:180px">
        </div>
