...
$(document).ready(function() {
    ...
    var table = $('#resourcesTable').DataTable({
        ...
        dom: "<'d-flex align-items-center gap-2 mb-3'<'count-slot'>l<'ms-auto d-flex align-items-center gap-2'f<'resources-create-slot'>>>t<'d-flex align-items-start mt-2'i<'ms-auto'p>>"
    });
