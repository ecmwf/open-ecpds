...
<input class="form-control" name="search" type="text" placeholder="Search.." title="Search is performed across the Uid and Name in case-insensitive" value="${param['search']}">
</div>
</form>
