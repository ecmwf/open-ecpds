...
<input class="form-control" name="search" type="text" placeholder="Search.." title="Search is performed across the Name and Description in case-insensitive" value="${param['search']}">
</div>
</form>
