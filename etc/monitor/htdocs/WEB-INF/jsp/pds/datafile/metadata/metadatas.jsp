...
<p class="fw-bold mb-1 mt-2"><c:if test="${not empty attributeName}">All Meta Data Values for parameter <i>${attributeName}</i></c:if>
<c:if test="${empty attributeName}">All Meta Data Parameters</c:if></p>
