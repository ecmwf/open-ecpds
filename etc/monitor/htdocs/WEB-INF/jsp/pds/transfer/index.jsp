...
<div class="d-flex align-items-start gap-2 mb-4 px-2 py-2 rounded"
     style="background:rgba(25,135,84,0.05); border-left:4px solid var(--bs-border-color,#dee2e6); font-size:0.85rem; color:var(--bs-body-color); max-width:700px; margin: 0 auto;">
