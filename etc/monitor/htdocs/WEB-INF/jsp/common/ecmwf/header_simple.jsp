  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center px-4 pt-0 pb-4">
        ...
        <ul class="list-unstyled mb-3" style="font-size:0.82rem; line-height:2;">
        ...
        <div class="border-top pt-3 d-flex justify-content-center gap-3 flex-wrap" style="font-size:0.78rem; color:var(--bs-secondary-color,#6c757d);">
          <span><i class="bi bi-box me-1"></i>OpenECPDS <strong><%=ecmwf.common.version.Version.getFullVersion()%></strong></span>
          <span><i class="bi bi-cpu me-1"></i>Java <strong><%=System.getProperty("java.version")%></strong></span>
        </div>
      </div>
    </div>
  </div>
