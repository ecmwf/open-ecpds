...
--
-- Table structure for table `PORTAL_TRAFFIC`
--

DROP TABLE IF EXISTS `PORTAL_TRAFFIC`;
CREATE TABLE `PORTAL_TRAFFIC` (
  `PTR_USER`         varchar(64)   CHARACTER SET latin1 COLLATE latin1_bin NOT NULL DEFAULT '',
  `PTR_TIME`         datetime      NOT NULL,
  `PTR_CONNECTIONS`  int           NOT NULL DEFAULT 0,
  `PTR_BYTES_IN`     bigint        NOT NULL DEFAULT 0,
  `PTR_BYTES_OUT`    bigint        NOT NULL DEFAULT 0,
  `PTR_DURATION_IN`  bigint        NOT NULL DEFAULT 0,
  `PTR_DURATION_OUT` bigint        NOT NULL DEFAULT 0,
  PRIMARY KEY (`PTR_USER`, `PTR_TIME`),
  KEY `portalTrafficTime` (`PTR_TIME`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

LOCK TABLES `PORTAL_TRAFFIC` WRITE;
/*!40000 ALTER TABLE `PORTAL_TRAFFIC` DISABLE KEYS */;
/*!40000 ALTER TABLE `PORTAL_TRAFFIC` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `PORTAL_TRAFFIC_DAILY`
--

DROP TABLE IF EXISTS `PORTAL_TRAFFIC_DAILY`;
CREATE TABLE `PORTAL_TRAFFIC_DAILY` (
  `PTD_USER`         varchar(64)   CHARACTER SET latin1 COLLATE latin1_bin NOT NULL DEFAULT '',
  `PTD_DATE`         date          NOT NULL,
  `PTD_CONNECTIONS`  int           NOT NULL DEFAULT 0,
  `PTD_BYTES_IN`     bigint        NOT NULL DEFAULT 0,
  `PTD_BYTES_OUT`    bigint        NOT NULL DEFAULT 0,
  `PTD_DURATION_IN`  bigint        NOT NULL DEFAULT 0,
  `PTD_DURATION_OUT` bigint        NOT NULL DEFAULT 0,
  PRIMARY KEY (`PTD_USER`, `PTD_DATE`),
  KEY `portalTrafficDailyDate` (`PTD_DATE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

LOCK TABLES `PORTAL_TRAFFIC_DAILY` WRITE;
/*!40000 ALTER TABLE `PORTAL_TRAFFIC_DAILY` DISABLE KEYS */;
/*!40000 ALTER TABLE `PORTAL_TRAFFIC_DAILY` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `PORTAL_BYTES_SNAPSHOT`
--

DROP TABLE IF EXISTS `PORTAL_BYTES_SNAPSHOT`;
CREATE TABLE `PORTAL_BYTES_SNAPSHOT` (
  `PBS_USER`           varchar(64)  CHARACTER SET latin1 COLLATE latin1_bin NOT NULL DEFAULT '',
  `PBS_MINUTE`         datetime     NOT NULL,
  `PBS_UPLOAD_BYTES`   bigint       NOT NULL DEFAULT 0,
  `PBS_DOWNLOAD_BYTES` bigint       NOT NULL DEFAULT 0,
  PRIMARY KEY (`PBS_USER`, `PBS_MINUTE`),
  KEY `portalBytesSnapshotMinute` (`PBS_MINUTE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

LOCK TABLES `PORTAL_BYTES_SNAPSHOT` WRITE;
/*!40000 ALTER TABLE `PORTAL_BYTES_SNAPSHOT` DISABLE KEYS */;
/*!40000 ALTER TABLE `PORTAL_BYTES_SNAPSHOT` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `DESTINATION_BYTES_SNAPSHOT`
--

DROP TABLE IF EXISTS `DESTINATION_BYTES_SNAPSHOT`;
CREATE TABLE `DESTINATION_BYTES_SNAPSHOT` (
  `DBS_DESTINATION`    varchar(64)  CHARACTER SET latin1 COLLATE latin1_bin NOT NULL DEFAULT '',
  `DBS_MINUTE`         datetime     NOT NULL,
  `DBS_UPLOAD_BYTES`   bigint       NOT NULL DEFAULT 0,
  `DBS_DOWNLOAD_BYTES` bigint       NOT NULL DEFAULT 0,
  PRIMARY KEY (`DBS_DESTINATION`, `DBS_MINUTE`),
  KEY `destinationBytesSnapshotMinute` (`DBS_MINUTE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

LOCK TABLES `DESTINATION_BYTES_SNAPSHOT` WRITE;
/*!40000 ALTER TABLE `DESTINATION_BYTES_SNAPSHOT` DISABLE KEYS */;
/*!40000 ALTER TABLE `DESTINATION_BYTES_SNAPSHOT` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `MOVER_AVAILABILITY_SNAPSHOT`
--

DROP TABLE IF EXISTS `MOVER_AVAILABILITY_SNAPSHOT`;
CREATE TABLE `MOVER_AVAILABILITY_SNAPSHOT` (
  `MAS_MOVER`      varchar(32)  CHARACTER SET latin1 COLLATE latin1_bin NOT NULL DEFAULT '',
  `MAS_MINUTE`     datetime     NOT NULL,
  `MAS_AVAILABLE`  smallint(6)  NOT NULL DEFAULT 0,
  PRIMARY KEY (`MAS_MOVER`, `MAS_MINUTE`),
  KEY `moverAvailabilitySnapshotMinute` (`MAS_MINUTE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

LOCK TABLES `MOVER_AVAILABILITY_SNAPSHOT` WRITE;
/*!40000 ALTER TABLE `MOVER_AVAILABILITY_SNAPSHOT` DISABLE KEYS */;
/*!40000 ALTER TABLE `MOVER_AVAILABILITY_SNAPSHOT` ENABLE KEYS */;
UNLOCK TABLES;
...
(10052,'/do/transfer/destination/hostsStatus/efas_iconeu_opendata'),
(10060,'/do/transfer/destination/hostsStatus/efas_iconeu_opendata'),
(10052,'/do/transfer/destination/hostsStatus/hourly_aq'),
(10055,'/do/transfer/destination/hostsStatus/hourly_aq'),
(10052,'/do/transfer/destination/hostsStatus/s2s_kwbc_enfo'),
(10061,'/do/transfer/destination/hostsStatus/s2s_kwbc_enfo'),
(10052,'/do/transfer/destination/hostsStatus/wis2_sbo'),
(10059,'/do/transfer/destination/hostsStatus/wis2_sbo'),
...
(1004,'/do/transfer/host/'),
(10005,'/do/transfer/host/'),
(103,'/do/transfer/host/list'),
(104,'/do/transfer/host/list'),
(1004,'/do/transfer/host/list'),
(10005,'/do/transfer/host/list'),
(103,'/do/transfer/mapjson'),
(104,'/do/transfer/mapjson'),
(1004,'/do/transfer/mapjson'),
(10005,'/do/transfer/mapjson'),
(103,'/do/transfer/host/edit/'),
(104,'/do/transfer/host/edit/'),
(103,'/do/transfer/host/edit/geoIp'),
(105,'/do/transfer/host/edit/geoIp'),
(103,'/do/transfer/host/edit/getOutput/'),
(105,'/do/transfer/host/edit/getOutput/'),
...
CREATE TABLE `DATA_FILE` (
  ...
  KEY `disseminationSchedule` (`DAF_DOWNLOADED`,`HOS_NAME_FOR_ACQUISITION`,`DAF_GROUP_BY`),
...
CREATE TABLE `DATA_TRANSFER` (
  ...
  `DAT_GROUP_BY` varchar(64) DEFAULT NULL,
  PRIMARY KEY (`DAT_ID`),
  KEY `DAF_ID` (`DAF_ID`),
  ...
  KEY `replicateRequest2` (`STA_CODE`,`DAT_DELETED`,`DAT_EXPIRY_TIME`),
  KEY `disseminationDownload` (`STA_CODE`,`DAT_DELETED`,`DAT_GROUP_BY`,`DAT_QUEUE_TIME`,`DAT_ID`),
  KEY `disseminationGroupBy` (`DAF_ID`,`DAT_DELETED`,`STA_CODE`),
...
('efas_iconeu_opendata','anonymous','de',0,0,5,-1,30000,2,600000,0,'',0,0,0,0,1,'Acquisition of DWD ICON-EU forecasts for EFAS [328 files (344,05 MB) per day]',0,1200000,1759154183598,0,14,10000,1,'STOP','admin',1,0,0,'none',NULL,1,0,-1,0,'yyyyMMdd',0,'internet','scheduler.standby = \"yes\"\n###### END-OF-PROPERTIES ######\n'),
('hourly_aq','anonymous','us',0,0,5,-1,30000,2,600000,0,'',0,0,0,0,1,'Acquisition of hourly_aq data in the ASCII format from USEPA [24 files (17,21 MB) per day]',0,1200000,1759154573465,0,9,10000,1,'STOP','admin',1,0,0,'none',NULL,1,0,-1,0,'yyyyMMdd',0,'internet','mqtt.contentType = \"application/json\"\nmqtt.expiryInterval = \"PT48H\"\nmqtt.publish = \"yes\"\nmqtt.retain = \"yes\"\nscheduler.standby = \"yes\"\n###### END-OF-PROPERTIES ######\n// Variables substituted at runtime: $filename, $filesize, $destination, $date, $time,\n// $timefile (ms epoch), $uuid, $checksum, $movername, $datatransferid\nvar destination = "$destination";\nvar filename = "$filename";\nvar filesize = $filesize;\nvar pubtime = new Date($timefile).toISOString();\nvar dataId = destination + "/" + filename;\n// Host/ports used to build access URLs - adjust if not using standalone defaults\nvar host = "localhost";\nvar httpsPort = 7443;\nvar sftpPort = 7022;\nvar baseUrl = "https://" + host + ":" + httpsPort + "/";\nvar s3Url = "https://" + host + ":" + httpsPort + "/s3/";\nvar sftpUrl = "sftp://test@" + host + ":" + sftpPort + "/";\nreturn {\n  mqtt: {\n    payload: JSON.stringify({\n      id: "$uuid",\n      type: "Feature",\n      geometry: null,\n      properties: {\n        datetime: pubtime,\n        pubtime: pubtime,\n        data_id: dataId,\n        content_length: filesize\n      },\n      links: [\n        { rel: "canonical", type: "application/octet-stream", length: filesize,\n          href: baseUrl + filename, title: "Download via HTTPS" },\n        { rel: "alternate", type: "application/octet-stream", length: filesize,\n          href: sftpUrl + filename, title: "Download via SFTP" },\n        { rel: "alternate", type: "application/octet-stream", length: filesize,\n          href: s3Url + filename, title: "Download via S3" }\n      ]\n    })\n  }\n};\n'),
('s2s_kwbc_enfo','anonymous','de',0,0,5,-1,30000,2,600000,0,'',0,0,0,0,1,'S2S project, Ensemble Forecast from NCEP [16 files (2,64 GB) per day]',0,1200000,1759156182523,0,15,10000,1,'STOP','admin',1,0,0,'none',NULL,1,0,-1,0,'yyyyMMdd',1,'internet','scheduler.standby = \"yes\"\n###### END-OF-PROPERTIES ######\n'),
('wis2_sbo','admin','ex',0,0,10,-1,60000,5,600000,0,'admin@ecmwf.int',0,0,0,0,1,'WIS2 surface data acq [~50K files (~60 MB) per day]',0,1200000,1759154285020,4,13,10000,0,'STOP','admin',1,0,0,'none',NULL,1,0,-1,0,'yyyyMMdd',0,'internet','scheduler.standby = \"yes\"\n###### END-OF-PROPERTIES ######\n');
...
--
-- Table structure for table `PORTAL_SUBSCRIBER`
--

DROP TABLE IF EXISTS `PORTAL_SUBSCRIBER`;
CREATE TABLE `PORTAL_SUBSCRIBER` (
...
CREATE TABLE `PRODUCT_METADATA` (
  ...
  `PRM_GROUP_TIMES` tinyint(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `SYS_CONFIG` (
  `SCF_GROUP` varchar(64) NOT NULL,
  `SCF_PARAM_NAME` varchar(128) NOT NULL,
  `SCF_PARAM_VALUE` text DEFAULT NULL,
  `SCF_UPDATED_AT` datetime DEFAULT NULL,
  PRIMARY KEY (`SCF_GROUP`,`SCF_PARAM_NAME`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TRANSFER_HISTORY` (
  ...
  `TRH_USER_STATUS` varchar(64) DEFAULT NULL,
...
('genericAzure','azure','$msuser[login]:$msuser[passwd]@$msuser[host]/$msuser[dir]$target',0,1,'Microsoft Azure protocol implementation (azure-storage-blob-12.14.3)',1),
('genericFtp','ftp','$msuser[login]:$msuser[passwd]@$msuser[host]/$msuser[dir]$target',0,1,'FTP protocol implementation',1),
('genericFtps','ftps','$msuser[login]:$msuser[passwd]@$msuser[host]/$msuser[dir]$target',0,1,'FTPS protocol implementation (ftp4j-rv1.7.2)',1),
('genericGcs','gcs','$msuser[login]:$msuser[passwd]@$msuser[host]/$msuser[dir]$target',0,1,'Google Cloud Storage protocol implementation (google-cloud-storage-2.38.0)',1),
('genericHttp','http','$msuser[login]:$msuser[passwd]@$msuser[host]/$msuser[dir]$target',0,1,'HTTP/S & MQTT protocol implementation (httpclient5-5.3.1/paho.mqttv5-1.2.5)',1),
('genericPortal','portal','$msuser[login]:$msuser[passwd]@$msuser[host]/$msuser[dir]$target',0,1,'Notification only with no data transfer',1),
('genericS3','s3','$msuser[login]:$msuser[passwd]@$msuser[host]/$msuser[dir]$target',0,1,'Amazon S3 protocol implementation (aws-java-sdk-bundle-1.12.547)',1),
('genericSftp','sftp','$msuser[login]:$msuser[passwd]@$msuser[host]/$msuser[dir]$target',0,1,'SFTP protocol implementation (jsch-0.2.17)',1),
('genericTest','test','$msuser[dir]$target',0,1,'Test method to simulate data transfers',1),
('genericWebdav','webdav','$msuser[login]:$msuser[passwd]@$msuser[host]/$msuser[dir]$target',0,1,'WebDAV protocol implementation (jackrabbit-webdav-2.22.3)',1);
...
('ecpds-mover','internet',NULL,0,1759149642865,'',7640,0,1,0,1);
...
('/do/transfer/destination/hostsStatus/efas_iconeu_opendata'),
('/do/transfer/destination/hostsStatus/hourly_aq'),
('/do/transfer/destination/hostsStatus/s2s_kwbc_enfo'),
('/do/transfer/destination/hostsStatus/wis2_sbo'),
...
('/do/transfer/host'),
('/do/transfer/host/'),
('/do/transfer/host/list'),
('/do/transfer/mapjson'),
('/do/transfer/host/edit/'),
('/do/transfer/host/edit/geoIp'),
('/do/transfer/host/edit/getOutput/'),
