...
('/do/datafile/datafile/list'),
('/do/datafile/datarates'),
('/do/datafile/diskusage'),
('/do/datafile/diskusage/'),
('/do/datafile/metadata'),
('/do/datafile/metadata/'),
('/do/datafile/moverdiskusage'),
('/do/datafile/moverdiskusage/'),
('/do/datafile/moverdownloads'),
('/do/datafile/moverdownloads/'),
('/do/datafile/moverdownloads/data'),
('/do/monitoring'),
('/do/monitoring/'),
('/do/monitoring/arrival/getimage'),
('/do/monitoring/timeline/getimage'),
('/do/monitoring/transfer/getimage'),
('/do/product/'),
('/do/transfer'),
('/do/transfer/'),
('/do/transfer/data/'),
...
('/do/user/history'),
('/do/user/history/'),
('/do/user/history/list'),
('/do/user/incoming'),
('/do/user/incoming/'),
('/do/user/incoming/list'),
('/do/user/policy'),
('/do/user/policy/'),
('/do/user/resource'),
('/do/user/resource/'),
('/do/user/resource/edit/'),
('/do/user/resource/list'),
('/do/user/user'),
('/do/user/user/'),
('/do/user/user/edit/'),
('/do/user/user/list'),
('/do/admin/requeue/list');
